...
class ChallengePage extends Component {
    ...
    checkBadgeValidation = async () => {
        try {
            let response = await axios.get("/groupMember/validation2",
                {
                    headers: {
                    },
                    params: {
    ...
    getBadgeHandler = async () => {
        try {
            let response = await axios.post("/groupMember/getBadge",
                {
                    headers: {
                    },
                    params: {
    ...
    leaveChallenge = async () => {
        try {
            let response = await axios.delete("/groupMember/leave",
                {
                    headers: {
                    },
                    params: {
