...
class Main extends Component {
    ...
    getChallengeData = async () => {
        let temp = [];
        try {
            let response = await axios.get("/myGroupList",
                {
                    headers: {
                    },
    ...
    insertGroupMember = async () => {
        ...
        try {
            let response = await axios.post("/groupMember/inviteMember",
                {
                    headers: {
                    },
    ...
    getPopularityData = async () => {
        let temp = [];
        try {
            let response = await axios.get("/myGroupList/popularity");
            console.log(response);
            if (response.data.rows.length != 0) {
                for (let i = 0; i < response.data.rows.length; i++) {
                    temp.push(response.data.rows[i]);
    ...
    applyPopularity = async () => {
        try {
            let response = await axios(
                {
                    method: 'post',
                    url: '/groupMember/inviteApplyMember',
                    headers: {
                    },
                    params: {
                        master_realid: this.userData.realId,
